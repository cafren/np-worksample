...
public class SwedishPhoneNumberValidator implements StringFormatValidator {
	...
	private static final Pattern pattern = Pattern.compile("(?:\\+[0-9]|0)[0-9 -]+[0-9]");
	...
	public static void main(String args[]) {
		...
		tests.add(new Test("-0732193727", false));
		tests.add(new Test("0732193727-", false));
		tests.add(new Test("707768989", false));
		...
		tests.add(new Test("02345678", true));
		tests.add(new Test("023456789012345", true));
		tests.add(new Test("0234567890123456", false));
