...
public class WSUtils {
	...
	public static void setTimeouts(BindingProvider bindingProvider, int connectionTimeout, int requestTimeout){
		...
		requestContext.put("com.sun.xml.ws.connect.timeout", connectionTimeout * MillisecondTimeUnits.SECOND);
		...
		requestContext.put("com.sun.xml.ws.request.timeout", requestTimeout * MillisecondTimeUnits.SECOND);
