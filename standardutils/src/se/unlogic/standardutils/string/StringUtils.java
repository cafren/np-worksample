...
public class StringUtils {
	...
	public static String toSentenceCaseMultiWord(String string) {
		...
		for(int index = 0; index < splitString.length; index++) {
			...
			stringBuilder.append(toSentenceCase(splitString[index]));
	...
	public static String substringBeforeLast(String string, String snippet) {
		
		int index = string.lastIndexOf(snippet);
