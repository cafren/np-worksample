...
public class XMLGenerator {
	...
	public static Element toXML(Object bean, Document doc) {
		...
		if (doc instanceof XMLGeneratorDocument) {
			...
			triggerRootElementableListener(generatorDocument, classElement, bean);
		}
	...
	private static void triggerElementableListener(XMLGeneratorDocument doc, Element subElement, Object fieldValue) {
		...
		if (doc != null) {
			...
			@SuppressWarnings("rawtypes")
			ElementableListener elementableListener = doc.getFieldElementableListener(fieldValue.getClass());
	...
	@SuppressWarnings("unchecked")
	private static void triggerRootElementableListener(XMLGeneratorDocument doc, Element subElement, Object fieldValue) {

		if (doc != null) {

			@SuppressWarnings("rawtypes")
			ElementableListener elementableListener = doc.getRootElementableListener(fieldValue.getClass());
